  ...
  <div class="row content">
   <div class="col-sm-2">
    ...
    <div class="col-sm-8 text-left" style="text-align:center">
      ...
      <h3 style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;">Kelowna, BC</h3><p>&nbsp;</p>
      <hr>
      	<img src="images/shop3.jpg" alt="Image" class="img-responsive">
      	<h3 style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;">Toronto, ON</h3><p>&nbsp;</p>
      <hr>
      	<img src="images/shop4.jpg" alt="Image" class="img-responsive">
      	<h3 style="font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;">New Delhi, India</h3><p>&nbsp;</p>
      <hr>
